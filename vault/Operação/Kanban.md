...
- [ ] AUD-06 — Terminar escrita atômica do `ball_log` (multi-mesa ainda perde bolas) — [[AUD-06 Perda de bolas no ball_log]]
- [ ] AUD-08 — Tirar configurações de jogo do localStorage por aparelho — [[AUD-08 Configurações vivem no localStorage]]
