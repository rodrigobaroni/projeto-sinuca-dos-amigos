export const NAV = [
  ...
  { key: "jogador", label: "Jogador", icon: '<circle cx="12" cy="8" r="4" stroke="currentColor" stroke-width="2" fill="none"/><path d="M4 21a8 8 0 0116 0" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"/>' },
...
export const EVEN_BALLS = [2, 4, 6, 8, 10, 12, 14];
export const ODD_BALLS = [3, 5, 7, 9, 11, 13, 15];
